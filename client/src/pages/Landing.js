  ...
  return (
    <div>
      <section className="hero">
        <div>
          <h1>Merge your <span>workspace.</span></h1>
          <p className="hero-sub">Write grants and proposals faster. Get funding easier.</p>
          <p className="lead">Merge is the shared workspace where your team writes grant proposals. Split the application into questions, give each one to a teammate, keep every answer inside its limit, and merge it all into one polished document.</p>
          <div className="cta">
